...
internal actual object PosixParkingDelegator : ParkingDelegator {
    actual override fun createRef(): Any {
        val combo = ParkingData(nativeHeap.alloc<pthread_mutex_tVar>().ptr, nativeHeap.alloc<pthread_cond_tVar>().ptr)
    ...
    internal data class ParkingData(val mut: CPointer<pthread_mutex_tVar>, val cond: CPointer<pthread_cond_tVar>) {
